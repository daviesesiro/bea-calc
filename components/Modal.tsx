...
const Modal: React.FC<Props> = ({ title, subtitle, closeModal, children }) => {
    return (
        <React.Fragment>
            ...
            <div className='rounded-xl left-2/4 top-2/4 -translate-x-2/4 -translate-y-2/4 fixed z-30 w-10/12 px-5 py-8 transform bg-white'>
                ...
                <div className=' mb-8'>
                    ...
                    {subtitle && <p className='text-xs font-light'>{subtitle}</p>}
