...
const Transaction: React.FC<Props> = ({
  ...
  const Icon = receiving ? (
    ...
    >
      <path
        d="M23 1L13.5 10.5L8.5 5.5L1 13"
        stroke="#6DFF0E"
        strokeWidth={2}
        strokeLinecap="round"
  ...
  const handleDelete = async () => {
    if (confirm("Are you sure you want to delete this transaction?")) {
      ...
      setState((old) => ({
        ...
        totalBalance:
          type === "Receiving"
            ? old.totalBalance - amount
            : old.totalBalance + amount,
        transactions: {
          ...old.transactions,
          [personId]: old.transactions[personId].filter((x) => x.id != id),
        },
  ...
  return (
    <React.Fragment>
      <div
        className={`relative flex items-center justify-between p-4 rounded-lg mx-5 mb-4
             ${receiving ? "bg-receive-transaction" : "bg-send-transaction"} `}
      >
        {transactionDate && (
          <p className="top-2 right-2 absolute text-xs text-gray-200">
        ...
        <div className="flex flex-col flex-1 text-white">
          ...
          <p className="font-sans-2 text-3xl font-light">
        ...
        <div>
          ...
          >
            ...
            >
              <path
                d="M1 11.8333H3.5C3.94203 11.8333 4.36595 12.0089 4.67851 12.3215C4.99107 12.634 5.16667 13.058 5.16667 13.5V16M5.16667 1V3.5C5.16667 3.94203 4.99107 4.36595 4.67851 4.67851C4.36595 4.99107 3.94203 5.16667 3.5 5.16667H1L5.16667 1ZM16 5.16667H13.5C13.058 5.16667 12.634 4.99107 12.3215 4.67851C12.0089 4.36595 11.8333 3.94203 11.8333 3.5V1L16 5.16667ZM11.8333 16V13.5C11.8333 13.058 12.0089 12.634 12.3215 12.3215C12.634 12.0089 13.058 11.8333 13.5 11.8333H16L11.8333 16Z"
                stroke="white"
                strokeWidth={2}
                strokeLinecap="round"
                strokeLinejoin="round"
      ...
      {showModal && (
        ...
        >
          ...
          <div className="mb-4">
            ...
            <p className="dark:text-gray-200 text-lg">
